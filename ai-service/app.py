...
def compare_inspections():
    try:
        ...
        auth_token = data.get('authToken')  # tenant/landlord JWT, passed through from Node
        ...
        # Fetch both inspections from the Node backend
